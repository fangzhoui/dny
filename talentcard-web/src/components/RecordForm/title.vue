<template>
  <div>
    <el-form :model="detailform" class="demo-form-inline" style="padding-left:40px">
      <el-row>
        <el-col :span="12">
          <el-form-item label="职称：">{{ detailform.category | titleFilter }}</el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="职称信息：">{{ detailform.info || "无" }}</el-form-item>
        </el-col>
      </el-row>
      <el-form-item>
        <el-col :span="6" class="right">专业技术资格照片/扫描件：</el-col>
        <el-col :span="18">
